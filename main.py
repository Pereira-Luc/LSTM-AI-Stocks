...
if __name__ == "__main__":
    ...
    train_data, test_data, X_train, y_train, X_test, y_test = get_data_for_prediction(apple_data, historical_information, 0.9)
